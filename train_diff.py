...
from models_cuda_diff import ModeTv2_diff_model
import random
def same_seeds(seed):
...
def main():
    ...
    head_dim = 6
    num_heads = [8,4,2,1,1]
    save_dir = 'ModeTv2_cuda_diff_nh({}{}{}{}{})_hd_{}_ncc_{}_reg_{}_lr_{}_54r/'.format(*num_heads, head_dim,weights[0], weights[1], lr)
    ...
    Initialize model
    '''
    model = ModeTv2_diff_model(img_size, head_dim=head_dim, num_heads=num_heads, scale=1)
    model.cuda()
